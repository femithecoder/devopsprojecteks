...
# server {
#     listen 80;
#     server_name jenkins.olorunfemilawal.com;
...
# sudo certbot --nginx -d jenkins.olorunfemilawal.com --email femithecoder@gmail.com --non-interactive --agree-tos --redirect
...
# echo "Jenkins is now accessible via https://jenkins.olorunfemilawal.com"
